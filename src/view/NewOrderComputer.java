...
import controller.NewOrderComputerController;
import controller.UpdateDataForOrderComputer1;
import controller.UpdateDataForOrderComputer2;
...
public class NewOrderComputer extends JFrame {
    ...
    public NewOrderComputer(Shop shop, OrderList orderList) {
        ...
        comboBoxNumber
                .addActionListener(new UpdateDataForOrderComputer1(comboBox, totalPrice, shop));
        comboBox.addActionListener(new UpdateDataForOrderComputer2(comboBoxNumber, comboBox,
